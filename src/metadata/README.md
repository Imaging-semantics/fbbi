 ...
 * [fbbi.yml](fbbi.yml)
     * Determines how your purl.obolibrary.org/obo/fbbi/ redirects will be handled
     ...
     * Paste in the contents of [fbbi.yml](fbbi.yml)
 ...
 * [fbbi.md](fbbi.md)
     ...
     * Paste in the contents of [fbbi.md](fbbi.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
