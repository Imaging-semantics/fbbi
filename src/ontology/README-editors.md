These notes are for the EDITORS of fbbi
...
Make sure you have an ID range in the [idranges file](fbbi-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [fbbi-edit.owl](fbbi-edit.owl)

** DO NOT EDIT fbbi.obo OR fbbi.owl in the top level directory **

[../../fbbi.owl](../../fbbi.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/Imaging-semantics/fbbi) for details.
 ...
 * [fbbi-idranges.owl](fbbi-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/fbbi_terms.txt file
...
Note: the fbbi_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as fbbi.owl and fbbi.obo and places
 ...
 * https://github.com/Imaging-semantics/fbbi/releases
 * https://github.com/Imaging-semantics/fbbi/releases/new
...
what is in the `owl:versionIRI` of the derived fbbi.owl (`data-version` in
fbbi.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/fbbi.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/fbbi/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/Imaging-semantics/fbbi.svg?branch=master)](https://travis-ci.org/Imaging-semantics/fbbi)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/Imaging-semantics](https://travis-ci.org/profile/Imaging-semantics)
 2. click the "Sync account" button
 3. Click the tick symbol next to fbbi
